def main():https://github.com/ClarksvilleMontgomeryCountySchoolSystem/play-dohtasks-WillaIsCool15/blob/main/task3.py
    color1 = "gray"
    color2 = "pink"
...
# CAUTION: You must include the word "body" when checking!
    ...
    print(f"6) Add four small legs to the bottom using red.\n")
